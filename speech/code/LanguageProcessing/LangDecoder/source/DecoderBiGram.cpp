...
namespace lang {
    ...
    //
    // Class lang::BiGramDecoder::_CharFreqIndex
    //
    BiGramDecoder::_CharFreqIndex::_CharFreqIndex()
    {
        // init chars' table
    ...
    void BiGramDecoder::_CharFreqIndex::putChar(unsigned char c)
    {
        _CharDescr& elem = m_charFreq_index[c];
        elem.pair.second++;
    }

    void BiGramDecoder::_CharFreqIndex::sort(void)
    {
    ...
    int BiGramDecoder::_CharFreqIndex::getCharIndex(unsigned char c)
    {
...
//        }
    ...
    //
    // Class lang::BiGramDecoder
    //
    BiGramDecoder::BiGramDecoder()
    {
        ;
    }

    bool BiGramDecoder::trainLanguage(const std::string& file_in, LanguageID language)
    {
    ...
    LanguageID BiGramDecoder::resolveLanguage(const std::string& file_in)
    {
        unsigned char* file_data = NULL;
        unsigned int data_len = 0;
        // read file data 
    ...
    // Internal methods
    //   
    void BiGramDecoder::_fillFreqVector(_CharFreqIndex& index, const unsigned char* file_data, unsigned int data_len)
    {
    ...
    void BiGramDecoder::_trainLanguageModel(_LangDescr& lang_descr, const unsigned char* file_data, unsigned int data_len)
    {        
    ...
    mt::Real BiGramDecoder::_calcInputProbabilityWithLang(st::BiGram<int>& testModel, _CharFreqIndex& encodedIndex, const unsigned char* file_data, unsigned int data_len)
    {
